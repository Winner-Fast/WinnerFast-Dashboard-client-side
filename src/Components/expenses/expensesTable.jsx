                ...
                <div className="fixed inset-0 flex justify-center items-center">
                    <div className="w-full max-w-md bg-white shadow-md rounded-lg p-4">
                        ...
                        <form onSubmit={handleSubmit(AddNewExpense)} className="w-full">
                            ...
                            <div className="pb-2 pt-2">
                                <input {...register('category', {minLength:  { value: 3, message: "Category must be at least 3 characters long" }, pattern: { value: /^[A-Za-z]+(?:\s[A-Za-z]+)*$/, message: "Your category must be a valid name composed with 2 words max"
